...
Konfigurator is a flexible configuration toolkit, at the begining strongly 
inspired by Sinatra framework settings. Now thanks to it you can easy implement 
configuration options to your apps, modules or classes.  
